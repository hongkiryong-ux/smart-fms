...
class UserRole(str, enum.Enum):
    ...
    kumho_facility_section = "kumho_facility_section"
    baegun_facility_section = "baegun_facility_section"
    sdc_section = "sdc_section"
    seawater_desalination_section = "seawater_desalination_section"
    partner = "partner"
    external = "external"
    viewer = "viewer"
...
class CentralControlRoomDaily(Base):
    """중앙관제실 1일 검침 (웹 입력)."""

    __tablename__ = "central_control_room_daily"
    ...
    __table_args__ = (
        UniqueConstraint("building_id", "log_date", name="uq_ccr_daily"),
    )


class CentralControlRoomArchive(Base):
    """중앙관제실 1일 시트 엑셀 아카이브."""

    __tablename__ = "central_control_room_archives"
    ...
    __table_args__ = (
        UniqueConstraint("building_id", "log_date", name="uq_ccr_archive"),
    )
...
class SteelworksHqDaily(Base):
    """제철소본부 1일 검침 (전기·설비)."""

    __tablename__ = "steelworks_hq_daily"
    ...
    __table_args__ = (
        UniqueConstraint("building_id", "log_date", name="uq_swhq_daily"),
    )


class SteelworksHqArchive(Base):
    """제철소본부 1일 엑셀 아카이브."""

    __tablename__ = "steelworks_hq_archives"
    ...
    __table_args__ = (
        UniqueConstraint("building_id", "log_date", name="uq_swhq_archive"),
    )


class SteelworksHallDaily(Base):
    """제철회관 운영일보(난방) 1일."""

    __tablename__ = "steelworks_hall_daily"
    ...
    __table_args__ = (
        UniqueConstraint("building_id", "log_date", name="uq_swhall_daily"),
    )


class SteelworksHallArchive(Base):
    """제철회관 운영일보 1일 아카이브."""

    __tablename__ = "steelworks_hall_archives"
    ...
    __table_args__ = (
        UniqueConstraint("building_id", "log_date", name="uq_swhall_archive"),
    )
...
class EoulrimGymDaily(Base):
    """어울림체육관 운영일보[냉,난방] 1일."""

    __tablename__ = "eoulrim_gym_daily"
    ...
    __table_args__ = (
        UniqueConstraint("building_id", "log_date", name="uq_egym_daily"),
    )


class EoulrimGymArchive(Base):
    """어울림체육관 운영일보 1일 아카이브."""

    __tablename__ = "eoulrim_gym_archives"
    ...
    __table_args__ = (
        UniqueConstraint("building_id", "log_date", name="uq_egym_archive"),
    )


class BaegunDormDaily(Base):
    """백운생활관 설비 점검일지[냉,난방] 1일."""

    __tablename__ = "baegun_dorm_daily"
    ...
    __table_args__ = (
        UniqueConstraint("building_id", "log_date", name="uq_bdorm_daily"),
    )


class BaegunDormArchive(Base):
    """백운생활관 설비 점검일지 1일 아카이브."""

    __tablename__ = "baegun_dorm_archives"
    ...
    __table_args__ = (
        UniqueConstraint("building_id", "log_date", name="uq_bdorm_archive"),
    )


class GigaTownDaily(Base):
    """기가타운 운영일보 1일."""

    __tablename__ = "giga_town_daily"
    ...
    __table_args__ = (
        UniqueConstraint("building_id", "log_date", name="uq_gtown_daily"),
    )


class GigaTownArchive(Base):
    """기가타운 운영일보 1일 아카이브."""

    __tablename__ = "giga_town_archives"
    ...
    __table_args__ = (
        UniqueConstraint("building_id", "log_date", name="uq_gtown_archive"),
    )
...
class Sub53Daily(Base):
    """53서브(53Sub-station) 운영일보 1일."""

    __tablename__ = "sub53_daily"
    ...
    __table_args__ = (
        UniqueConstraint("building_id", "log_date", name="uq_sub53_daily"),
    )


class Sub53Archive(Base):
    """53서브 운영일보 1일 아카이브."""

    __tablename__ = "sub53_archives"
    ...
    __table_args__ = (
        UniqueConstraint("building_id", "log_date", name="uq_sub53_archive"),
    )


class BaegundaeDaily(Base):
    """백운대 점검일지 1일."""

    __tablename__ = "baegundae_daily"
    ...
    __table_args__ = (
        UniqueConstraint("building_id", "log_date", name="uq_baegundae_daily"),
    )


class BaegundaeArchive(Base):
    """백운대 점검일지 1일 아카이브."""

    __tablename__ = "baegundae_archives"
    ...
    __table_args__ = (
        UniqueConstraint("building_id", "log_date", name="uq_baegundae_archive"),
    )
