/** 중앙관제실 1일 일지 — 자동 저장 · 드래그 선택 · 삭제 · 엑셀 붙여넣기 */
(function () {
  const form = document.querySelector(".ccr-daily-form");
  const statusEl = document.getElementById("ccr-save-status");
  ...
  function setStatus(text, cls) {
    ...
    statusEl.className = "ccr-save-status " + (cls || "");
  }
