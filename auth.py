...
ROLE_LABELS = {
    ...
    UserRole.maintenance_section: "정비섹션",
    UserRole.operations_support_section: "운영지원섹션",
    UserRole.kumho_facility_section: "금호시설섹션",
    UserRole.baegun_facility_section: "백운시설섹션",
    UserRole.sdc_section: "SDC섹션",
    UserRole.seawater_desalination_section: "해수담수섹션",
...
SIGNUP_ROLES: tuple[UserRole, ...] = (
    ...
    UserRole.maintenance_section,
    UserRole.operations_support_section,
    UserRole.kumho_facility_section,
    UserRole.baegun_facility_section,
    UserRole.sdc_section,
    UserRole.seawater_desalination_section,
    UserRole.viewer,
    UserRole.partner,
    UserRole.external,
)
